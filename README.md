...
- [x] `process-eight:module:create:frontend:view-model` command asks for `LAYOUT_XML_NAME` twice. Fix it.
- [x] `process-eight:module:create:frontend:view-model` command inserts `LAYOUT_XML_BLOCK_NAME` as the value of the Fix it.
